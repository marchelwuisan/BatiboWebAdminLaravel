                ...
                <form class="w-full" action="{{ route('products.update', $item->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('detail') ?? $item->detail }}" name="detail" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Detail Product">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6 ">
                        ...
                        <div class="w-1/3 px-3">
                            ...
                            <input value="{{ old('discount') ?? $item->discount}}" name="discount" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" max="100" placeholder="Discount">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
